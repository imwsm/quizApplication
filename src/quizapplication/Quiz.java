...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String name){
        this.name=name;
        setBounds(50,10,1280,755);
        getContentPane().setBackground(Color.white);
        setLayout(null);
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("icons/quiz.jpg"));
        JLabel image=new JLabel(i1);
        image.setBounds(0, 0, 1280, 380);
        add(image);
        ...
        question.setBounds(151,450, 850, 30);
        ...
        LifeLine.setBounds(900,570,150,40);
        ...
        submit.setBounds(900,620,150,40);
    ...
    public void paint(Graphics g){
        ...
        if(timer>=0){
            g.drawString(time, 1045, 515);
        }else{
            g.drawString("Times Up!!", 1045,515);
        }
        timer--;
        try{
            Thread.sleep(1000);
